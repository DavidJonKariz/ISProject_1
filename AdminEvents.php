...
{
$res=mysqli_query($con,"SELECT * FROM `clubs` ");
    echo'
<html>
    <head>
...
if (isset($_POST["Search"]))
{
 $res=mysqli_query($con,"SELECT * FROM `clubs` WHERE `club_ID`= '$_POST[Search]' OR `club_Name`= '$_POST[Search]' OR `club_activities`= '$_POST[Search]' OR `club_status`='$_POST[Search]'");
   echo'
<html>
    <head>
